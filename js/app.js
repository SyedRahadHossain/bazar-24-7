  ...
  for (const product of allProducts) {
    ...
    div.innerHTML = `
      <div class="single-product">
          ...
          <h6>Rating: ${Array.from(Array(parseInt(rate)).keys()).map(
          ...
          <button id="details-btn" onclick='loadDetails(${product.price},${rate})' type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#exampleModal">Details</button>
      </div>
      `;
